...
#  s.source_files = 'KDFoundation/Classes/**/*'
  ...
  s.subspec 'Category' do |ss|
    ss.source_files = 'KDFoundation/Category/*.{h,m,mm,cc}'
    ss.public_header_files = 'KDFoundation/Category/**/*.h'
  end

# s.subspec 'SafeKit' do |ss|
#  ss.source_files = 'KDFoundation/SafeKit/*.{h,m,mm,cc}'
#   ss.public_header_files = 'KDFoundation/SafeKit/*.h'
# end

  s.subspec 'MBProgressHUD' do |ss|
    ss.source_files = 'KDFoundation/MBProgressHUD/*.{h,m,mm,cc}'
    ss.public_header_files = 'KDFoundation/MBProgressHUD/*.h'
  end
