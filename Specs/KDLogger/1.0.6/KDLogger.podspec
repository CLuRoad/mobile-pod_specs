...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.subspec 'default' do |ss|
   ss.source_files = 'KDLogger/Classes/default/*.{h,m}'
   ss.dependency 'KDLogger/core'
  end

  s.subspec 'core' do |ss|
   ss.source_files = 'KDLogger/Classes/core/*.{h,m}'
   ss.dependency 'KDLogger/utils'
  end

  s.subspec 'utils' do |ss|
   ss.source_files = 'KDLogger/Classes/utils/*.{h,m}'
  end
